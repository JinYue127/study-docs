<template>
  <div class="meta-wrapper">
    <div class="meta-item original">
      <el-tag v-if="isOriginal" type="success">原创</el-tag>
      <el-tag v-else type="primary">转载</el-tag>
    </div>
    <div class="meta-item">
    ...
    <div class="meta-item">
      <span class="meta-icon date">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
              d="M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z m0 820c-205.4 0-372-166.6-372-372s166.6-372 372-372 372 166.6 372 372-166.6 372-372 372z"></path><path
    ...
    <div class="meta-item" v-if="showViewCount">
      <span class="meta-icon pv">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>阅读数</title><path
    ...
    <div class="meta-item" v-if="showCategory">
      <span class="meta-icon category">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>所属分类</title><path
    ...
    <div class="meta-item tag">
      <span class="meta-icon tag">
        <svg role="img" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><title>标签列表</title><path
      ...
      <span class="meta-content">
        <span v-for="(tag, index) in tags" :key="index">
          <a href="javascript:void(0);" @click="goToLink('/study-docs/archives', 'tag', tag)" target="_self" :title="tag">{{
              tag
            }}</a>
