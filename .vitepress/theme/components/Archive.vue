  ...
  <div class="timeline-wrap">
    ...
    <div class="timeline-header">
      <div v-if="$category" class="header-item">
        ...
        <el-button @click="goToLink('archives')" :icon="Close" circle
    ...
    <div class="timeline-item" v-for="(item, year) in archiveData">
      <div class="year">
        <img class="chinese-zodiac" @click="goToLink('archives', 'year', year?.replace('年', ''))"
          ...
          <div class="articles">
            <span v-for="article in articles" class="article">
              <svg v-if="article.categories.includes('Bug万象集')"
                   @click="goToLink('archives', 'category', article.categories[0])" role="img"
              ...
              <svg v-else @click="goToLink('archives', 'category', article.categories[0])" role="img"
